...
CANON = ROOT/'analysis_unpack/nba_player_game_analysis_ready_v1/player_game_panel_model_at_risk_analysis_ready.csv.gz'
CADENCE = ROOT/'cadence_harmonized_results/player_team_game_harmonized_cadence.csv.gz'
TV = ROOT/'tv/nba_announced_tv_six_seasons_v1/announced_tv_six_seasons.csv'
OUT = ROOT/'nonlinear_multinomial_stage_v1'
...
'''
    ...
    zpath=Path('/mnt/data/nba_nonlinear_multinomial_robustness_v1.zip')
