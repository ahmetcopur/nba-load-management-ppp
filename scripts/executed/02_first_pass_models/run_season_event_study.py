...
out=Path('/mnt/data/_model_run');event.to_csv(out/'season_event_study_absence.csv',index=False);tab.to_csv(out/'season_event_study_all_coefficients.csv',index=False)
